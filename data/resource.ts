...
export const resourceData: ResourceCategory[] = [
  ...
  },
  {
    ...
    resources: [
      ...
      },
      {
        ...
        desc: '一个查看JavaScript 文章、新闻和很棒的项目的时事通讯',
  ...
  },
  {
    ...
    resources: [
      {
        name: 'Devdocs',
        desc: 'DevDocs 将多个开发人员文档结合在一个干净有序的 Web UI 中，具有即时搜索、离线支持、移动版本、深色主题、键盘快捷键等。',
  ...
  },
  {
    ...
    resources: [
      ...
      },
      {
        name: 'Draw',
        desc: '免费免登录在线流程图思维导图',
        logo: 'https://www.draw.io/images/logo.png',
  ...
  },
  {
    ...
    resources: [
      ...
      },
      {
        ...
        logo: 'https://cdn.vuetifyjs.com/docs/images/logos/vuetify-logo-v3-dark.svg',
  ...
  },
  {
    ...
    resources: [
      ...
      {
        name: 'UI Notes',
        desc: 'UI Notes 收集了大量线上优秀 App 的完整 UI 截图，只有落地设计没有飞机稿',
        logo: 'https://uinotes.com/public/img/logo.svg',
        href: 'https://uinotes.com/',
        tags: ['设计'],
      },
    ],
  },
  ...
  },
  {
    ...
    resources: [
      ...
      {
        name: 'Niva',
        desc: 'Niva是基于 Tauri WRY 跨端 Webview 库的超轻量极易用的跨端应用开发框架',
        logo: 'https://bramblex.github.io/niva/img/logo.svg',
        href: 'https://bramblex.github.io/niva/docs/intro',
        tags: ['跨平台', 'Webview'],
      },
      {
        name: 'Flutter',
